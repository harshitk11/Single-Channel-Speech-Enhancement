...
[rawsig1,fs1] = audioread('C:\Users\admin\Documents\MATLAB\obama.mp3');  % raw signals
fsk = 8000;
[p,q] = rat(fsk/fs1);
...
rawsign = awgn(rawsig,30);

audiowrite('C:\Users\admin\Documents\MATLAB\obama15.wav',rawsign,8000);
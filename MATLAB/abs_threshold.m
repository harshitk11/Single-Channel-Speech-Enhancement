...
function t_abs_bark = abs_threshold(rawsig)
...
t_abs_bark = zeros(18,1);

t_abs_bark(1) = mean([t_abs(1) t_abs(3)]);  
t_abs_bark(2) = mean([t_abs(4) t_abs(6)]);
t_abs_bark(3) = mean([t_abs(7) t_abs(10)]);
t_abs_bark(4) = mean([t_abs(11) t_abs(13)]);
t_abs_bark(5) = mean([t_abs(14) t_abs(16)]);
t_abs_bark(6) = mean([t_abs(17) t_abs(20)]);
t_abs_bark(7) = mean([t_abs(21) t_abs(25)]);
t_abs_bark(8) = mean([t_abs(26) t_abs(29)]);
t_abs_bark(9) = mean([t_abs(30) t_abs(35)]);
t_abs_bark(10) = mean([t_abs(36) t_abs(41)]);
t_abs_bark(11) = mean([t_abs(42) t_abs(47)]);
t_abs_bark(12) = mean([t_abs(48) t_abs(55)]);
t_abs_bark(13) = mean([t_abs(56) t_abs(64)]);
t_abs_bark(14) = mean([t_abs(65) t_abs(74)]);
t_abs_bark(15) = mean([t_abs(75) t_abs(86)]);
t_abs_bark(16) = mean([t_abs(87) t_abs(100)]);
t_abs_bark(17) = mean([t_abs(101) t_abs(118)]);
t_abs_bark(18) = mean([t_abs(119) t_abs(128)]);

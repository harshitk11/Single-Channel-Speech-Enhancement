 ...
 %        pp.ti          % desired frame increment [0.seconds]
 ...
 %        pp.b           % max noise attenutaion in power domain [0. %        pp.al          % SNR for oversubtraction=am (set this to Inf for fixed a) [-5 dB]
 ...
 %        pp.taminh    % (3): min smoothing time constant (upper limit) [0. seconds]
 ...
 %        pp.qith      % Q-inverse thresholds to select maximum noise slope [0..05 0.06 Inf ]
 ...
 %        pp.pnsaf    % noise probability safety value [0.(24)
...
%      Proc IEEE ICASSP, 1979, 4, 208-211
 ...
 %        IEEE Trans. Speech and Audio Processing, 9(5):504-512, July 2
 %    [3] Gerkmann, T. & Hendriks, R. C.
 %        Unbiased MMSE-Based Noise Power Estimation With Low Complexity and Low Tracking Delay
 %        IEEE Trans Audio, Speech, Language Processing, 2 20, 1383-1393
 
 %      Copyright (C) Mike Brookes 2 %      Version: $Id: specsub.m 1720 21 17:17:31Z dmb $
 %
 ...
 %   Free Software Foundation, Inc.,675 Mass Ave, Cambridge, MA  9, USA.
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
